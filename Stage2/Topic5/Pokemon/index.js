...
// 1. Oyunun qaydalarına uygun düymelere cilck olunmasa ekrana xeta cixacq
// 2. Bizim ve komp secimi 
// 3. Qalibin teyin olunmasi
// 4. Oyun bitdikden sonra yeniden baslamaq ucun restart duymesinin islenmesi
// 5. Xal sisteminin qurulmasi
...
window.addEventListener("keydown", function(e){
    ...
    }else if(userChoose == "e" && compChoose == "f"){
